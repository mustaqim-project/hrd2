...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <?= form_open_multipart('gaji/tampil_rekap_gaji_petra_ariesca'); ?>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a class="btn btn-danger btn-lg btn-sm btn-block" href="<?= base_url('gaji/rekap_gaji_petra_ariesca'); ?>">CANCEL</a>
