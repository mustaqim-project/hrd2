...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="<?= base_url('gaji/downloadrekapgajipetraexcell/'); ?><?= $mulai_tanggal . '/' . $sampai_tanggal  ?>" target="_blank" class="btn btn-success mb-2 ml-4"><i class="fas fa-download"></i> Download Rekap Gaji Format Excell</a>
            <a href="<?= base_url('gaji/downloadrekapgajipetrapdf/'); ?><?= $mulai_tanggal . '/' . $sampai_tanggal  ?>" target="_blank" class="btn btn-danger mb-2 ml-4"><i class="fas fa-download"></i> Download Rekap Gaji Format PDF </a>
