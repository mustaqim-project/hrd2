...
<div class="card">
    ...
    <div class="card-body">
        <canvas id="grafikStatusNikah"></canvas>
    </div>
</div>
...
<div class="card mt-4">
    ...
    <div class="card-body">
        <canvas id="grafikJenisKelamin"></canvas>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var ctx1 = document.getElementById('grafikStatusNikah').getContext('2d');
        new Chart(ctx1, {
            type: 'pie',
            data: {
        ...
        // Grafik Jenis Kelamin
        var ctx2 = document.getElementById('grafikJenisKelamin').getContext('2d');
        new Chart(ctx2, {
            type: 'bar',
            data: {
