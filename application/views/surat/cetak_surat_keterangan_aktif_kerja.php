...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <?= form_open_multipart('surat/cetaksuratketeranganaktifkerja'); ?>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a class="btn btn-danger btn-lg btn-sm btn-block" href="<?= base_url('surat/keteranganaktifkerja'); ?>">CANCEL</a>
