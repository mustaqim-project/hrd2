...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <?= form_open_multipart('surat/cetakinventarismotor'); ?>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="perusahaan_id" class="col-md-6 col-form-label"><b>Merk Motor</b></label>
                    <input type="text" class="form-control" placeholder="Merk Motor" name="merk_motor" readonly="readonly">
                </div>
                <div class="form-group col-md-6">
                    <label for="perusahaan_id" class="col-md-6 col-form-label"><b>Type Motor</b></label>
                    <input type="text" class="form-control" placeholder="Type Motor" name="type_motor" readonly='readonly'>
                </div>
            </div>

            <!-- Button Simpan Dan Cancel -->
            <button type="submit" formtarget="_blank" class="btn btn-primary btn-sm btn-lg btn-block">CETAK</button>
            <a class="btn btn-danger btn-lg btn-sm btn-block" href="<?= base_url('surat/inventarismotor'); ?>">CANCEL</a>
