...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <?= form_open_multipart('surat/cetakinventarislaptop'); ?>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="perusahaan_id" class="col-md-6 col-form-label"><b>Merk Laptop</b></label>
                    <input type="text" class="form-control" placeholder="Merk Laptop" name="merk_laptop" readonly="readonly">
                </div>
                <div class="form-group col-md-6">
                    <label for="perusahaan_id" class="col-md-6 col-form-label"><b>Type Laptop</b></label>
                    <input type="text" class="form-control" placeholder="Type Laptop" name="type_laptop" readonly='readonly'>
                </div>
            </div>

            <!-- Button Simpan Dan Cancel -->
            <button type="submit" formtarget="_blank" class="btn btn-primary btn-sm btn-lg btn-block">CETAK</button>
            <a class="btn btn-danger btn-lg btn-sm btn-block" href="<?= base_url('surat/inventarislaptop'); ?>">CANCEL</a>
