...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <?= form_open_multipart('laporan/cetaklaporankaryawankontrak'); ?>
    <div class="card">
        <h5 class="card-header">Form <?= $title; ?></h5>
        <div class="card-body">

            <div class="alert alert-info" role="alert">
                Silakan Pilih Penempatan Karyawan Kontrak
            </div>
            ...
            <a class="btn btn-danger btn-lg btn-sm btn-block" href="<?= base_url('laporan/karyawankontrak'); ?>">CANCEL</a>
